...
static int parse_args(all_args_t* args, int argc, char* argv[])
{
  ...
  common.add_options()
    ...
    ("rrc.msg3_loop_enable",    bpo::value<bool>(&args->stack.rrc.msg3_loop_enable)->default_value(false),                        "Enable Msg1/Msg2/Msg3 loop mode with in-process hot reset")
    ("rrc.msg3_loop_target",    bpo::value<uint32_t>(&args->stack.rrc.msg3_loop_target)->default_value(1000),                     "Target number of successful Msg3 cycles in loop mode")
    ("rrc.msg3_loop_delay_ms",  bpo::value<uint32_t>(&args->stack.rrc.msg3_loop_delay_ms)->default_value(5),                      "Delay between Msg3 loop cycles in ms")
